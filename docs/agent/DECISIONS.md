...
**决策**：V1 内部版使用**品牌流派名**，后续公开版本再泛化

- 罗马纳（Romana's Pilates / Classical）
- 斯多特（Stott Pilates）
- 北极星（Polestar Pilates）
- BASI（Body Arts & Science International）

**理由**：
- V1 仅内部教练使用，品牌名辨识度高、教练熟悉
- 真实用户反馈：用品牌名更直观，泛化名字反而不好理解
- 后续若面向公众，可切换为泛化名（经典派/当代派/康复派/健身派）
